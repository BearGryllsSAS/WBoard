...
class WBBoardController;                // 白板控制器
class WBWebController;                  // 网页控制器
class WBControlView;
class WBPreferencesController;          // 偏好控制器
class WBResources;
class WBSettings;                       // 应用管理设置
class WBPersistenceManager;
class WBApplicationController;          // 应用控制器
class WBDocumentController;             // 文档控制器
class WBMainWindow;                     // 程序主窗口
